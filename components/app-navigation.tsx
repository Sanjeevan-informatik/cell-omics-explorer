...
export function AppNavigation() {
  ...
  return <aside className="platform-navigation"><Link className="platform-brand" href="/">CellOmics<span>Explore · Analyze · Learn</span></Link><nav aria-label="Workspaces"><section><h2>Overview</h2>{link("/atlas", "Unified Omics Atlas")}</section>
