...
import { UploadCloud, Database, Trash2, CheckCircle2, CircleAlert } from 'lucide-react';
...
export function DataHub() {
 ...
 const [category,setCategory]=useState<DataCategory>('genome');const [selected,setSelected]=useState<string|null>(null);const [message,setMessage]=useState('');const [busy,setBusy]=useState(false);const [drag,setDrag]=useState(false);const input=useRef<HTMLInputElement>(null);const importing=useRef(false);
