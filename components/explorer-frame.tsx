...
export function ExplorerFrame({module='cell'}:{module?:WorkspaceId}) {
 const {datasets}=useDataSession();const [demo,setDemo]=useState(false);const [selected,setSelected]=useState('');
